...
def addcustomer():
    conobj=mysql.connector.connect(host='localhost',user='root',passwd='okyaar',\
                                   database='PETROLPUMP')
...
def searchbyid():
    ...
    if a==[]:
        ...
        print('\t\t----------------')
        print(tabulate(a,headers=['CUSTOMERNO','NAME','PHONE NUMBER','POINTS'],tablefmt='fancy_grid'))
    conobj.close()
    
#Function to search customer details by Phone Number
def searchbyphone():
    conobj=mysql.connector.connect(host='localhost',user='root',passwd='okyaar',database='PETROLPUMP')
    curobj=conobj.cursor()
    while True:
        phone=input('Enter the phone number of the customer:')
        if len(phone)!=10 or phone.isdigit()==False:
    ...
    if a==[]:
        ...
        print('\t\tCustomer Details')
        print('\t\t----------------')
        print(tabulate(a,headers=['CUSTOMERNO','NAME','PHONE NUMBER','POINTS'],\
                       tablefmt='fancy_grid'))
...
def modifyphone():
    ...
    if data==[]:
        ...
        print('\t\tCustomer Details')
        print('\t\t----------------')
        print(tabulate(data,headers=['CUSTOMERNO','NAME','PHONE NUMBER','POINTS'],\
                       tablefmt='fancy_grid'))
        while True:
...
#Function to display transactions of a particular date
def date_transaction():
    ...
    q='select * from revenue \
        where date_refill="{}"'.format(todate)
    curobj.execute(q)
    data=curobj.fetchall()
    print(tabulate(data,headers=['FUEL-TYPE','TOTAL AMOUNT'],\
                                 tablefmt='fancy_grid'))
...
#Function to display transactions between given dates
...
def reports():
    while True:
        ...
        print("2.Revenue within date range ")
        print("3.Detailed trasaction of a particular date")
        print("4.Detailed trascation within a date range")
...
def admin_menu():
    while True:
        ...
        print("5.View rates of particular date")
        print("6.Reports")
